...
namespace AlgorithmTool
{
    ...
    public struct rtMotor_Cfg
    {
        ...
        public void LoadDefault()
        {
            ...
            tPID_PowerCoe.eKi = PLC_Ini.PID_POWER_COE_KI;
            tPID_ThetaOffsetCoe.eKi = PLC_Ini.PID_THETA_OFFSET_COE_KI;
            tPID_MotorAngleCoe.eKi = PLC_Ini.PID_ANGLE_CAR_MOTOR_COE_KI;

            tPID_PowerCoe.eKd = PLC_Ini.PID_POWER_COE_KD;
            tPID_ThetaOffsetCoe.eKd = PLC_Ini.PID_THETA_OFFSET_COE_KD;
            tPID_MotorAngleCoe.eKd = PLC_Ini.PID_ANGLE_CAR_MOTOR_COE_KD;
